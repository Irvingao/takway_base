...
class Config:
    def __init__(self, config_path: str):
        if not os.path.isfile(config_path) and os.path.isfile("./takway/tts/bert_vits/default_config.yml"):
            shutil.copy(src="./takway/tts/bert_vits/default_config.yml", dst=config_path)
            print(
