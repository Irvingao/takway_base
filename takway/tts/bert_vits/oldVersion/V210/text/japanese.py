...
tokenizer = AutoTokenizer.from_pretrained("./takway/tts/bert_vits/bert/deberta-v2-large-japanese-char-wwm")
...
if __name__ == "__main__":
    tokenizer = AutoTokenizer.from_pretrained("./takway/tts/bert_vits/bert/deberta-v2-large-japanese")
