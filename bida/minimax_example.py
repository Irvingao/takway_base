...
def my_stream_process_data(data, args):         
...
while True:
    ...
    result = llm.chat(prompt=user_prompt, 
                      stream_callback_args=args,
                      return_full_content=True) 
    # print(llm.conversation.append_message('user', "我吃了很多饭，你在干什么？"))
    # print(llm.conversation.append_message('assistant', "你吃什么饭？"))
    print("Bot:", result)
    print("!!!!!!!!!!!!!!!!")
    
    print("Conversation:", llm.conversation)
